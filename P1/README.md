...
- Desk research: [Análisis Competencia](Competitive%20Analysis/AnalisisCompetitivo.png)
- 2 Personas: [John](Personas/John.png) [Sofia](Personas/Sofia.png)
- 2 User Journey Map  ( 1 por persona): [John](User%20Journey%20Map/UJM%20John.pdf) [Sofia](User%20Journey%20Map/UJM%20Sofia.png)
...
La creación de las **User Personas (John y Sofía)** nos ha permitido empatizar con necesidades opuestas: la urgencia de eficiencia del perfil Agile y la necesidad de seguridad y calma del perfil Slow-living. Gracias a los **User Journey Maps**, ahora tenemos identificados los momentos clave donde nuestra plataforma bimodal debe aportar valor para reducir la fricción.
